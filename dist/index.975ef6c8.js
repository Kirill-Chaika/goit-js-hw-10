...
const onSourch = (e)=>{
    ...
    (0, _catApi.fetchCountries)(textInput).then((data)=>{
        console.log(data);
        if (data.length > 10) {
...
const creatList = (country)=>{
    return country.map(({ id , url  })=>`<li class="link"><img src="${url}" alt="${id}" width="60" height="40"> <p class = "list-name";>${id}</p></li>`).join("");
};
const creatInfo = (country)=>{
    return country.map(({ id , url , breeds , favourite  })=>` <div class="cauntry-items">  <img src="${url}" alt="${id}" width="200" height="100">
        <h1>${id}</h1>
        <p>Capital: ${breeds}</p>
...
input.addEventListener("input", (0, _lodashDebounceDefault.default)(onSourch, DEBOUNCE_DELAY));

},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","notiflix/build/notiflix-notify-aio":"eXQLZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./js/cat-api":"5IWAT"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
/**
...
const fetchCountries = (name)=>{
    ...
    const API_Key = {
        "x-api-key": "live_qX3jDfl6LZPHo4tDqz6q5vYSj5jz1oaxYAyuWKQJvqhuR1sOgNl1Mq09li2F8LNh"
    };
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["igKGj","1xC6H","8lqZg"], "8lqZg", "parcelRequired7c6")
