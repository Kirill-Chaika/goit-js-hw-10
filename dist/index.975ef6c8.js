...
function App() {
    ...
    const [selectedBreed, setSelectedBreed] = (0, _react.useState)("");
    const [catInfo, setCatInfo] = (0, _react.useState)(null);
    ...
    (0, _react.useEffect)(()=>{
        if (selectedBreed) {
            setLoading(true);
            setError(false);
            (0, _catApi.fetchCatByBreed)(selectedBreed).then((data)=>{
                setCatInfo(data[0]);
                setLoading(false);
            }).catch((error)=>{
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        children: [
            ...
            catInfo && /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                className: "cat-info",
                children: [
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("h2", {
                        className: "cat-name",
                        children: catInfo.breeds[0].name
                    }, void 0, false, {
                        fileName: "src/index.js",
                        lineNumber: 104,
                        columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("p", {
                        ...
                        children: catInfo.breeds[0].description
                    }, void 0, false, {
                        fileName: "src/index.js",
                        lineNumber: 105,
                        columnNumber: 11
...
_s(App, "uGwXTcNjhgIsGkjL11u9wtoHhQs=");
_c = App;
exports.default = App;
var _c;
$RefreshReg$(_c, "App");
...
},{"react/jsx-dev-runtime":"iTorj","./js/cat-api":"5IWAT","react":"21dqq","slim-select":"lzHUr","slim-select/dist/slimselect.css":"6O4cs","notiflix/dist/notiflix-3.2.6.min.css":"1IPtg","./css/styles.css":"1CY4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}],"iTorj":[function(require,module,exports) {
"use strict";
...
},{}],"5IWAT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const fetchCatByBreed = (breedId)=>{
    ...
    return (0, _axiosDefault.default).get(url).then((response)=>response.data).catch((error)=>{
        console.error("Error fetching cat by breed:", error);
...
},{}],"6O4cs":[function() {},{}],"1IPtg":[function() {},{}],"1CY4s":[function() {},{}],"km3Ru":[function(require,module,exports) {
"use strict";
...
},{"7422ead32dcc1e6b":"786KC"}]},["igKGj","1xC6H","8lqZg"], "8lqZg", "parcelRequired7c6")
